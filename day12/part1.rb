...
def main
  ...
  pos = find_pos(chart, 'S')
  step_memo[pos[1]][pos[0]] = 0
  end_pos = find_pos(chart, 'E')
  step_memo = explore_neighbors(chart, pos[0], pos[1], step_memo)
  puts step_memo[end_pos[1]][end_pos[0]]
end
